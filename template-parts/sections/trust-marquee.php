...
<section class="py-12 bg-white reveal-on-scroll">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-6 items-center text-center opacity-70 hover:opacity-100 transition-opacity" data-reveal-group>
